...
-- SELECT * FROM books AS b JOIN authors AS a ON b.author_id = a.id WHERE nationality = 'China' OR nationality='UK';

-- Find out how many books Albert Camus wrote.
-- SELECT count(*) FROM books AS b JOIN authors AS a ON b.author_id = a.id WHERE name = 'Albert Camus';

-- Find out how many books were written by US authors.
--  SELECT count(*) FROM books AS b JOIN authors AS a ON b.author_id = a.id WHERE nationality = 'United States of America';
