...
VALUES
  ('Rawan Alrajeh', 'Saudi Arabia', 1996);

-- Add two books that you'd like to write (you can hard-code your id as the author id)
INSERT INTO books
  (title,publication_date,author_id)
VALUES('The Story of the Stone', 1760, 1),
  ('The Unbearable Lightness of Being', 1984, 6);

-- Update one of your books to have a new title
UPDATE books SET title = 'The Joke' WHERE id = 6;

-- Delete your books
DELETE FROM books WHERE author_id = 1 AND author_id = 6;
